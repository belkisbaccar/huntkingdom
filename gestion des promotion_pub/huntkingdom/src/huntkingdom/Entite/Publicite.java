...
public class Publicite {
    ...
    public List<Object> getListe_user_like() {
        return liste_user_like;
    }
    ...
    public void setListe_user_like(List<Object> liste_user_like) {
        this.liste_user_like = liste_user_like;
    }

    @Override
    public String toString() {
        return "Publicite{" + "id_publicite=" + id_publicite + ", nom=" + nom + ", image=" + image + ", date_debut=" + date_debut + ", date_fin=" + date_fin + ", nom_proprietaire=" + nom_proprietaire + ", prix=" + prix + ", liste_user_like=" + liste_user_like + '}';
    }
